...
function Trending() {
  return (
    ...
    <div className="flex mt-6  ps-10  px-4  font-bold text-xl justify-between align-center">

<div className="gateway-heading  ">Trending Getaways</div>
<div><a href="" className='font-normal text-sm text-green2'>View all<i className="fa-solid fa-arrow-right"></i></a></div>

</div>
<div className='flex ml-10 container mx-auto'>
